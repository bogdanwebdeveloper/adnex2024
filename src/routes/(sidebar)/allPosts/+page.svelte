...
<div class="text-center p-10">
  <h1 class="font-bold text-4xl mb-4 dark:text-gray-300">Exploreaza optiunile tale!</h1>
  <h1 class="text-xl" style="color:#7e22ce">Aici poți găsi toate anunțurile postate.</h1>
</div>
