<script lang="ts">
	...
	export let title = 'Ai uitat parola?';
	export let site = {
		name: '',
	...
	export let btnTitle = 'Resetează parola';
	export let pageDescription =
		"Nu te panica, te rog să introduci un email și îti vom trimite un cod pentru resetare!";
